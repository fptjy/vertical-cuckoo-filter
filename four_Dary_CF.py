...
class D_ary_CF14_7(object):
    ...
    def _get_alternate1_index(self, index, fingerprint):
        a = D_aryCF.ten_to_four(index)
        b = D_aryCF.ten_to_four(hashutils.hash_code(fingerprint))
        c = D_aryCF.base_four_xor(a, b)
        alt_index1 = D_aryCF.four_to_ten(c) % self.capacity
        return alt_index1
    ...
    def _get_alternate2_index(self, index, fingerprint):
        ...
        b = D_aryCF.ten_to_four(hashutils.hash_code(fingerprint))
        c = D_aryCF.base_four_xor(a, b)
        c = D_aryCF.base_four_xor(c, b)
        alt_index2 = D_aryCF.four_to_ten(c) % self.capacity
        return alt_index2
    ...
    def _get_alternate3_index(self, index, fingerprint):
        ...
        c = D_aryCF.base_four_xor(c, b)
        c = D_aryCF.base_four_xor(c, b)
        alt_index3 = D_aryCF.four_to_ten(c) % self.capacity
        return alt_index3
