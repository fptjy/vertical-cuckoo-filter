...
class VCuckooFilter14_1(object):
    """
    Cuckoo Filter class.
    ...
    def _get_alternate1_index(self, index, fingerprint):
        alt_index1 = (index ^ (hashutils.hash_code(fingerprint) & 0b11111111111110)) % self.capacity
        return alt_index1

    def _get_alternate2_index(self, index, fingerprint):
        alt_index2 = (index ^ (hashutils.hash_code(fingerprint) & 0b00000000000001)) % self.capacity
        return alt_index2
