...
class VCuckooFilter14_7_DJBhash(object):
    """
    Cuckoo Filter class.
    ...
    def _get_alternate1_index(self, index, fingerprint):
        alt_index1 = (index ^ (hashutils_DJBhash.hash_code(fingerprint) & 0b01010101010101)) % self.capacity
        return alt_index1

    def _get_alternate2_index(self, index, fingerprint):
        alt_index2 = (index ^ (hashutils_DJBhash.hash_code(fingerprint) & 0b10101010101010)) % self.capacity
        return alt_index2
