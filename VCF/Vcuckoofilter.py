...
class VCuckooFilter(object):
    ...
    def __init__(self, capacity, bucket_size=1, fingerprint_size=16,
                 max_displacements=0):
        """
    ...
    def _get_alternate1_index(self, index, fingerprint):
        alt_index1 = (index ^ (hashutils.hash_code(fingerprint) & 0b1111111100000000)) % self.capacity
        return alt_index1

    def _get_alternate2_index(self, index, fingerprint):
        alt_index2 = (index ^ (hashutils.hash_code(fingerprint) & 0b0000000011111111)) % self.capacity
        return alt_index2
