...
class VCuckooFilter14_4(object):
    """
    Cuckoo Filter class.
    ...
    def _get_alternate1_index(self, index, fingerprint):
        alt_index1 = (index ^ (hashutils.hash_code(fingerprint) & 0b11111111110000)) % self.capacity
        return alt_index1

    def _get_alternate2_index(self, index, fingerprint):
        alt_index2 = (index ^ (hashutils.hash_code(fingerprint) & 0b00000000001111)) % self.capacity
        return alt_index2
