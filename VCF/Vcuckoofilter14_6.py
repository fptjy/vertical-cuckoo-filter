...
class VCuckooFilter14_6(object):
    """
    Cuckoo Filter class.
    ...
    def _get_alternate1_index(self, index, fingerprint):
        alt_index1 = (index ^ (hashutils.hash_code(fingerprint) & 0b01010101010100)) % self.capacity
        return alt_index1

    def _get_alternate2_index(self, index, fingerprint):
        alt_index2 = (index ^ (hashutils.hash_code(fingerprint) & 0b10101010101011)) % self.capacity
        return alt_index2
